...
function generateRandomNumber(min_num,max_num,precision) {
...
function coloring(data,color_start,color_end){
...
function draw_legend(rainbow,max_data){
	for (i = 1; i <=10; i++){
